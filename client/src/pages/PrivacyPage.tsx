  ...
  return (
    <div className="container mx-auto px-4 py-8">
      ...
      <div className="max-w-4xl mx-auto bg-white p-6 rounded-lg shadow-sm">
        <h1 className="text-3xl font-bold mb-6 text-brand-primary border-b pb-4">Política de Privacidad</h1>
        ...
        <div className="prose prose-lg max-w-none">
          ...
          <h2 className="text-xl font-semibold mt-6 mb-4 text-brand-primary">2.1. Responsable del Tratamiento</h2>
          ...
          <h2 className="text-xl font-semibold mt-6 mb-4 text-brand-primary">2.2. Datos recabados y finalidad</h2>
          <ul className="mb-4">
            <li className="mb-2">
          ...
          <h2 className="text-xl font-semibold mt-6 mb-4 text-brand-primary">2.3. Base de legitimación</h2>
          <ul className="list-disc ml-6 mb-4">
            <li>
          ...
          <h2 className="text-xl font-semibold mt-6 mb-4 text-brand-primary">2.4. Conservación</h2>
          <p className="mb-4">
          ...
          <h2 className="text-xl font-semibold mt-6 mb-4 text-brand-primary">2.5. Derechos de los usuarios</h2>
          <p className="mb-4">
          ...
          <h2 className="text-xl font-semibold mt-6 mb-4 text-brand-primary">2.6. Transferencias internacionales</h2>
          <p className="mb-4">
          ...
          <h2 className="text-xl font-semibold mt-6 mb-4 text-brand-primary">2.7. Seguridad</h2>
          <p className="mb-4">
